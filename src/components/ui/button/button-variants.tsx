...
export const buttonVariants = cva(
  'inline-flex items-center justify-center rounded-xl px-4 py-2 min-w-18 min-h-9 text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-2 cursor-pointer disabled:bg-disabled/80 disabled:pointer-events-none disabled:cursor-not-allowed disabled:text-white',
  {
    variants: {
      variant: {
        primary:
